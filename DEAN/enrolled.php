...
if (isset($_POST['undo'])) {
    ...
    if ($statusRow && $statusRow['status'] === 'enrolled') {
        ...
        if ($revertStmt->execute()) {
            echo "<script>alert('Status reverted to pre-enrolled.'); window.location.href = 'enrolled.php';</script>";
            exit;
        } else {
            echo "<script>alert('Failed to revert status.'); window.location.href = 'enrolled.php';</script>";
            exit;
        }
    }
}
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-content">
                                ...
                                <li><a href="enrolled.php"class="menu-item active" onclick="setActive(this)"><span class="las la-user-alt"></span><small>Enrolled</small></a></li>
                                <li><a href="rejected.php"><span class="las la-user-alt"></span><small>Rejected </small></a></li>
                            </ul>
                        </li>
                        <!-- <li>
                        ...
                        <?php foreach ($students as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="view-enrolled.php?user_id=<?php echo htmlspecialchars($row['student_id']); ?>" title="View"><span class="view">view</span></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
