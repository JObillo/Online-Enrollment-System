...
// Fetch pre-enrolled students using MySQLi with prepared statement
try {
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-content">
                                <li><a href="pre-enrolled.php" class="menu-item active" onclick="setActive(this)"><span class="las la-user-alt"></span><small>Pre-enrolled</small></a></li>
                        ...
                        <?php foreach ($students as $row) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="view-pre-enrolled.php?user_id=<?php echo htmlspecialchars($row['student_id']); ?>" title="View"><span class="view">view</span></a>
